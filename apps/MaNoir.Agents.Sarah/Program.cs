...
public static class Program
{
    public static async Task Main(string[] args)
    {
        ...
        builder.Services.AddSingleton<Zigbee2MqttCommandService>();
        builder.Services.AddSingleton<ShellyGen1CommandService>();
        builder.Services.AddSingleton<ShellyGen2CommandService>();
